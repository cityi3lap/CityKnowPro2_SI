...
const ResultSubjectStudent = ({ idForFetch, showAllData, nameItemClicked }) => {
    ...
    if (isLoaded) {
        ...
        return (
            <div className="col-12">
                ...
                <CardGraph tabs={tabs} jsonApi={jsonApi} showAllData={showAllData} heightGraph={225} widthGraph={768} typeGraph={'line'} />
