...
const PdfGenerateInform = forwardRef(({ jsonApiCompetitions, jsonApiIntelligence, jsonApiStyles, name, isLoaded, intelligenceForCompentition, styleForCompentition, isDataIntelligences, isDataStyles }, ref) => {
            ...
            <div>
                <ul className="nav justify-content-around nav-tabs" role="tablist">
                    <li className="nav-item">
                        <a className="nav-link-conventions active" href="#intelligences" role="tab" data-toggle="tab" >Informe por Inteligencias multiples, estilos y perfil vocacional</a>
                    </li>
                    <li className="nav-item">
                ...
                <div className="tab-content" ref={ref}>
                    <div role="tabpanel" className="tab-pane fade in active show" id="intelligences" >
                        <div className="content-pdf p-5" >
                            ...
                            <TitlePdfInform title={`Informe de inteligencias múltiples`} />
