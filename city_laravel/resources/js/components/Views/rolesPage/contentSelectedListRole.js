...
const ContentSelectedListRole = ({ infoPermissions }) => {
    ...
    const urlFetch = `http://127.0.0.1:8000/updateRole/${params.idForFetch}`
    useEffect(() => {
    ...
    async function fetchData() {
        try {
            let result = await fetchApi(`http://127.0.0.1:8000/getRole/${params.idForFetch}`)
            setJsonApi(result)
    ...
    if (isLoaded) {
        ...
        return (
            <div className='col-md-6 container container-roles-page'>
                <div className='card ' >
                    <div className='d-flex justify-content-between mt-1 mb-1'>
                        <TittleTab tittle={'Información del Rol'} />
                        {/* idModal need same at ButtonOpenModalEdit and ModalFloatButtons */}
