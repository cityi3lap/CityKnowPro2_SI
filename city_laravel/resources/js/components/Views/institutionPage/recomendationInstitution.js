...
const RecomendationInstitution = ({ idForFetch, nameItemClicked }) => {
    ...
    async function FetchSubject() {
        let subject = await fetchApi(`http://127.0.0.1:8000/recomendations/institution/${idForFetch}`)
    ...
    async function FetchIntelligences(params) {
        let itelliences = await fetchApi(`http://127.0.0.1:8000/intelligences/institution/${idForFetch}`)
...
export default RecomendationInstitution;