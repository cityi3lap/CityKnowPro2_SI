...
const ContentSelectedListGroup = (props) => {
    ...
    return (
        <div className="col-12 m-0">
            ...
            <ButtonGenerateInform idForFetch={`${idFetch[0]}/${idFetch[1]}`} routeFetchCompetitions={routeFetchCompetitions} routeFetchIntelligence={routeFetchIntelligence} routeFetchStyles={routeFetchStyles} routeFetchIntelligenceCompetitions={routeFetchIntelligenceCompetitions} routeFetchStyleCompetitions={routeFetchStyleCompetitions} nameItemClicked={props.nameItemClicked} />
        </div>
    )
}
