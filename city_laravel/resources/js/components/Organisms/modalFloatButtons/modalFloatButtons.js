...
import GroupCheckedBoxLocation from '../../Molecules/grupCheckedBoxForLocation';
                                    ...
                                    render={({ errors, status, touched }) => {
                                        ...
                                        return (
                                            <Form >
                                                ...
                                                <GroupCheckedBoxLocation locationUsers={locationUsers}  />
                                                ...
                                                <div className="modal-footer">
                                                    ...
                                                    <button type="submit" className="btn btn-primary mr-2">{textButton}</button>
